//Start here handles the go back button of the lyrics
...
// start here displays the lyrics on the page
...
// start here fetch the the lyrics of the song
...
//start here display the songs in the page
...
// start here handles the songs info
...
//start here fetch the results of the songs user entered
...
//start here handles the click after the user click the search button
document.getElementById("search-song").addEventListener("click", function () {
    ...
    // Clears the previous lists if any
	document.querySelector(".search-result").innerHTML = ""; 
	document.querySelector(".simple-result").innerHTML = ""; 
	fetchSongs(songName);
});